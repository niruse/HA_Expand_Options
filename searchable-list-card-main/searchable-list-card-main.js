...
class SearchableListCardMain extends LitElement {
...
customElements.define("searchable-list-card-main", SearchableListCardMain)

// ✅ Push updated card metadata to Home Assistant
window.customCards = window.customCards || []
window.customCards.push({
    type: "searchable-list-card-main",
    name: "Searchable List Card Main",
    preview: true,
